...
class CrawlDdev extends Command
{
     ...
     * @var string
     */
    protected $signature = 'crawl:ddev {--l|limit=250 : Only crawl a certain amount of URLs} {--c|concurrency=1 : Number of URLs to crawl in parallel per wave (1 = sequential, the default)} {--e|exclude= : Exclude URLs from crawling that contain the following paths, separate by comma} {--m|modes= : Comma-separated list of modes to enable (e.g. cache)}';
